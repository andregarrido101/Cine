...
public class SeatService {
    ...
    public void registrySeatPurchased(TicketCreateRequestDTO dto) {
        ...
        var ticket = verifyTicketExistence(dto);
    ...
    public TicketEntity verifyTicketExistence(TicketCreateRequestDTO dto) {
        return ticketRepository.findById(dto.sessionId())
